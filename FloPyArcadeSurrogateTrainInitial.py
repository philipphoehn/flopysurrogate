...
if reTrain:
	...
	hl1 = Dense(100, name='hl1', activation='relu')(inputState)
	hl2 = Dense(100, name='hl2', activation='relu')(hl1)
	hl3 = Dense(100, name='hl3', activation='relu')(hl2)
	...
	model.compile(loss='mean_squared_error', optimizer=optimizer, sample_weight_mode=['samplewise' for i in range(lenOutput)])
	...
	results = model.fit(X, [Y[:, i] for i in range(lenOutput)], sample_weight=sampleweightsAll,
